package com.wms.base.stockwarningset.controller;
...
@Controller
@RequestMapping("/base/stockWarningSet")
public class StockWarningSetController extends BaseController {

    @Autowired
    private IStockService stockService;

    private String prefix = "base/stockWarningSet";

    @RequiresPermissions("base:stockWarningSet:view")
    @GetMapping()
    public String inventoryWarning()
    {
        return prefix + "/stockWarningSet";
    }
     ...
     * 查询库存列表
     */
    @RequiresPermissions("base:stockWarningSet:list")
    @PostMapping("/selectStockWarningSetList")
    @ResponseBody
